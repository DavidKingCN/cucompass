...
/**
 * The Class AttrPicker.
 */
public class AttrPicker implements DataPicker {
	...
	public String get() {
		...
		try { needRt = XPathUtils.pathVal(pickAgent.getNode(), pickAgent.getPath(), true);} catch (XPatherException ignore) {}
