...
public class MatchUtils {
	...
	public static final String SBC_REG_EXP = "[\uFE30-\uFFA0]";
	
	public static final String htm_tag_reg_exp = "<.+?>";
	/**
	 * 将html标签去掉，只留存文本信息
	 * @param htm
	 * @param sep
	 * @return
	 */
	public static String replaceHtmTag(String htm,String sep){
		Pattern pattern = Pattern.compile(htm_tag_reg_exp, Pattern.DOTALL);
		Matcher matcher = pattern.matcher(htm);
		String string = matcher.replaceAll(sep);
