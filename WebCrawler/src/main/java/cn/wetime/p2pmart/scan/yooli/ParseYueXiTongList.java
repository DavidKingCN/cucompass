...
public class ParseYueXiTongList extends AbsYooliList {

	private static final String URL = "http://www.yooli.com/yuexitong/";
	...
	private  List<Product> getProductsByHtml(String result)
		...
		for (int i = 0; i < listLen; i++) {
			...
			lists = HtmlParseUtil.getNodeListByAttr(
					HtmlParseUtil.getParserByHtml(currNodeHtml),
					HtmlContants.ATTR_CLASS, COL_6_CLASS_NAME);
			...
			// platformName 平台名称
			product.setPlatformName("有利网-月息通");
	...
	public static void main(String[] args) throws Exception{
		WebCrawler webCrawler = new ParseYueXiTongList();
