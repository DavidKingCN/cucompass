...
import cn.com.davidking.xml.dom4j.Dom4jProcess;
// TODO: Auto-generated Javadoc

/**
 * The Class TestDom4jProcess.
 */
@SuppressWarnings("all")
public class TestDom4jProcess {
	...
	public static void main(String[] args) throws Exception{
		...
		XmlProcess xmlProcess = new Dom4jProcess(	file, Book.class);
		//检查xml文件是否合法
